...
public class RevealBackgroundView extends View {
    ...
    public void setFillPaintColor(@ColorRes int color) {
    ...
    public void startFromLocation(int[] tapLocationOnScreen) {
        ...
        //屏幕斜边...
        int c = getWidth() * getWidth() + getHeight() * getHeight();
        final Integer cInt = Integer.parseInt(new DecimalFormat("0").format(Math.sqrt(c)));
        revealAnimator = ObjectAnimator.ofInt(this, "currentRadius", cInt).setDuration(FILL_TIME);
