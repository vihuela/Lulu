...
public class GlobalMenuAdapter extends
        ArrayAdapter<GlobalMenuAdapter.GlobalMenuItem> {
    private static final int TYPE_MENU_ITEM = 0;
    private static final int TYPE_DIVIDER = 1;/* 线条 */
    ...
    private void setupMenuItems() {
        menuItems
                .add(new GlobalMenuItem(R.drawable.ic_global_menu_feed, "消息中心"));
        menuItems.add(new GlobalMenuItem(R.drawable.ic_global_menu_direct,
                "游戏中心"));
        menuItems
                .add(new GlobalMenuItem(R.drawable.ic_global_menu_news, "礼包大厅"));
        menuItems.add(new GlobalMenuItem(R.drawable.ic_global_menu_popular,
                "热点"));
        menuItems.add(new GlobalMenuItem(R.drawable.ic_global_menu_nearby,
                "附近的人"));
        menuItems.add(GlobalMenuItem.dividerMenuItem());
        menuItems
                .add(new GlobalMenuItem(R.drawable.ic_global_menu_nearby, "设置"));
        menuItems
                .add(new GlobalMenuItem(R.drawable.ic_global_menu_nearby, "绑定"));
    ...
    public int getItemViewType(int position) {
        return menuItems.get(position).isDivider ? TYPE_DIVIDER
                : TYPE_MENU_ITEM;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (getItemViewType(position) == TYPE_MENU_ITEM) {
            ...
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.item_global_menu,
                        parent, false);
            ...
            holder.ivIcon.setVisibility(item.iconResId == 0 ? View.GONE
                    : View.VISIBLE);
